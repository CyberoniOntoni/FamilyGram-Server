...
public partial class ObjectIdConsts
{
    ...
    public static readonly FrozenDictionary<uint, string> CommandServerHandlers = new Dictionary<uint, string>
    {
      ...
      { 0x51e842e1, "EditMessageHandler"},
      { 0xb106e66c, "EditMessageHandler"},
      ...
      { 0xde91436e, "ImportChatInviteHandler"},
      ...
      { 0x54ae308e, "SaveDraftHandler"},
      { 0xad0fa15c, "SaveDraftHandler"},
      ...
      { 0x545cd15a, "SendMessageHandler"},
      { 0xfef48f62, "SendMessageHandler"},
